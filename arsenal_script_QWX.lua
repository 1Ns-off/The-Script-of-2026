...
local kissLoader = Instance.new("TextLabel")
...
kissLoader.Name = "kissLoader"
kissLoader.Parent = Loader
kissLoader.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
kissLoader.BackgroundTransparency = 1.000
kissLoader.BorderColor3 = Color3.fromRGB(0, 0, 0)
kissLoader.BorderSizePixel = 0
kissLoader.Position = UDim2.new(0.123442277, 0, 0.157894731, 0)
kissLoader.Size = UDim2.new(0, 154, 0, 39)
kissLoader.Font = Enum.Font.JosefinSans
kissLoader.Text = "\"Kiss Me\""
kissLoader.TextColor3 = Color3.fromRGB(255, 255, 255)
kissLoader.TextSize = 20.000
kissLoader.TextWrapped = true
kissLoader.TextTransparency = 1
...
local pop = ts:Create(kissLoader, TweenInfo.new(1), {TextTransparency = 0})
pop:Play()
...
local trans = ts:Create(kissLoader, TweenInfo.new(1.5), {TextTransparency = 1})
trans:Play()
...
local UICorner_3 = Instance.new("UICorner")
local kissTitle = Instance.new("TextLabel")
...
ping.Text = "Click the rotating icon to open/close"
...
kissTitle.Name = "kissTitle"
kissTitle.Parent = Title
kissTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
kissTitle.BackgroundTransparency = 1.000
kissTitle.BorderColor3 = Color3.fromRGB(0, 0, 0)
kissTitle.BorderSizePixel = 0
kissTitle.Position = UDim2.new(0, 0, -0.000333150238, 0)
kissTitle.Size = UDim2.new(0, 329, 0, 25)
kissTitle.Font = Enum.Font.JosefinSans
kissTitle.Text = "\"Kiss Me\""
kissTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
kissTitle.TextSize = 14.000
kissTitle.TextWrapped = true
...
local menuSideToggle = Instance.new("Frame")
menuSideToggle.Name = "MenuSideToggle"
menuSideToggle.Size = UDim2.fromOffset(180, 210)
menuSideToggle.Position = UDim2.new(0, 10, 1, -235)
menuSideToggle.BackgroundTransparency = 1
menuSideToggle.ZIndex = 100
menuSideToggle.Parent = Main

local menuLogoBtn = Instance.new("ImageButton")
menuLogoBtn.Name = "MenuLogoButton"
menuLogoBtn.Size = UDim2.fromOffset(160, 160)
menuLogoBtn.AnchorPoint = Vector2.new(0.5, 0)
menuLogoBtn.Position = UDim2.new(0.5, 0, 0, 40)
menuLogoBtn.BackgroundColor3 = Color3.fromRGB(12, 12, 16)
menuLogoBtn.Image = "rbxassetid://7155344186"
menuLogoBtn.ScaleType = Enum.ScaleType.Fit
menuLogoBtn.AutoButtonColor = true
menuLogoBtn.BorderSizePixel = 0
menuLogoBtn.ZIndex = 101
menuLogoBtn.Parent = menuSideToggle
local menuLogoAspect = Instance.new("UIAspectRatioConstraint")
menuLogoAspect.AspectType = Enum.AspectType.FitWithinMaxSize
menuLogoAspect.AspectRatio = 1
menuLogoAspect.Parent = menuLogoBtn
local menuLogoCorner = Instance.new("UICorner")
menuLogoCorner.CornerRadius = UDim.new(1, 0)
menuLogoCorner.Parent = menuLogoBtn
...
local function toggleKissMenu()
	MenuIsToggled = not MenuIsToggled
	Basic.Visible = MenuIsToggled
	if not MenuIsToggled then
		Mods.Visible = false
	end
end

local menuRotateCon = RunService.RenderStepped:Connect(function(dt)
	menuLogoBtn.Rotation = (menuLogoBtn.Rotation + (dt * 36)) % 360
end)

menuLogoBtn.MouseButton1Click:Connect(toggleKissMenu)

local appear = ts:Create(Basic, TweenInfo.new(1.5), {BackgroundTransparency = 0.2})
appear:Play()

Close.MouseButton1Down:connect(function()
	if menuRotateCon then
		menuRotateCon:Disconnect()
		menuRotateCon = nil
	end
	Main:Destroy()
end)
...
RunService.RenderStepped:Connect(function ()
	...
	if Holding == true and _G.AimOn == true then
		...
		local part = closest and closest.Character and closest.Character:FindFirstChild(_G.Aimpart)
		if part then
			ts:Create(Camera, TweenInfo.new(_G.Sensitivity, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {CFrame = CFrame.new(Camera.CFrame.Position, part.Position)}):Play()
		end
	end
end)